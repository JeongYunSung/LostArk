...
sealed class AdvancedRefinement {
        ...
        companion object {
                ...
                fun getExpectedTryCount(advancedRefinement: AdvancedRefinement, level: Level, normalType: Type, bonusType: Type): Double {
                        val exp = advancedRefinement.getAverageNormalExp(normalType) * (1 - BONUS_RATE) + advancedRefinement.getAverageBonusExp(level, bonusType) * BONUS_RATE
